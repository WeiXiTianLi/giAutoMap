...
v2.011 添加了雷神瞳+稻妻地图，目前算是预览版，稳定性稍差
链接：https://pan.baidu.com/s/1ZWTO_az6ONBqL7UbTXFQ6Q 
提取码：88yg 
--来自百度网盘超级会员V5的分享

更新了启动器等，找好路径一键安装，只会在桌面创建快捷方式，纯净绿色版
进入需要设置游戏路径才能正常启动
启动器可以换背景了，改下background文件夹下图片的名称和config里面设置的一样就行
地图支持稻妻地图加雷神瞳了，稳定性还在调，先放出来给大家用
